...
import br.com.furb.restapifurb.controllers.ComandaController;
...
public class ComandaHandler {
    ...
    private static final Logger LOGGER = Logger.getLogger(ComandaHandler.class);
    ...
    public List<Comanda> getAll() {
        LOGGER.debug("getAll()");
        return Spring.bean(ComandaController.class).getAll();
    }
    ...
    public Comanda getById(@PathVariable UUID id) {
        ...
        return Spring.bean(ComandaController.class).getById(id);
    }
    ...
    public Comanda insert(@RequestBody ComandaDTO comandaDTO) {
        ...
        return Spring.bean(ComandaController.class).insert(comandaDTO.getIdUsuario(), comandaDTO.getProdutos(), comandaDTO.getValorTotal());
    }
    ...
    public Comanda put(@PathVariable UUID id, @RequestBody ComandaDTO comandaDTO) {
        ...
        return Spring.bean(ComandaController.class).put(id, comandaDTO.getIdUsuario(), comandaDTO.getProdutos(), comandaDTO.getValorTotal());
    }
    ...
    public String deleteById(@PathVariable UUID id) {
        ...
        return Spring.bean(ComandaController.class).deleteById(id);
    }
